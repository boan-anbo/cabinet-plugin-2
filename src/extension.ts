...
let previewPanel: HelloWorldPanel | undefined = undefined;
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  vscode.commands.registerCommand('cabinetplugin.startCabinet', () => {
     ...
     */
    const showHelloWorldCommand = commands.registerCommand("writing-plan.showHelloWorld", () => {

      previewPanel = HelloWorldPanel.render(context.extensionUri);
    });
    ...
    if (cabinetNodeInstance !== undefined) {
      ...
      context.subscriptions.push(commands.registerCommand("writing-plan.refresh-preview", () => {
        ...
        if (parseMdStructure) {
          previewPanel?.preview(parseMdStructure);
        } else {
